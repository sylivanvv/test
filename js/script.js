...
"use strict";
function showModal(id, modalContent, bgClassName, closeName){
    var modalLink = document.getElementById(id);
    var modalContent = document.querySelector(bgClassName);
